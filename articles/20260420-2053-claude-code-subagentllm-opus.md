...
セットアップ手順：3ステップで完結するステップ1：LM StudioでQwen3を起動LM Studioを起動してQwen3-30B-A3B（MoE、VRAM 24GBで動く）をロードする。ServerタブでローカルAPIを有効にすると、http://localhost:1234/v1でOpenAI互換エンドポイントが立つ。
