---
title: "Claude APIコスト1/30削減。Opusとローカルモデルの最適ルーティング"
emoji: "💰"
type: "tech"
topics: ["claude", "ai", "api", "agent", "cost"]
published: true
---
...
![]( /images/20260420-2053-claude-code-subagentとローカルllmで-opusトークン消費/fig3_routing_decision_tree.png)
...
![]( /images/20260420-2053-claude-code-subagentとローカルllmで-opusトークン消費/fig4_cost_timeline.png)
